...
Class Rewrite extends AbstractModel
{
    ...
    /** @var int */ public $url_rewrite_id; /** @var string */ public $source_path; /** @var string */ public $rewrite_path; /** @var int */ public $redirect; /** @var int */ public $redirect_external; /** @var string */ public $redirect_status;
    ...
    public static function match($uri)
    {
        ...
        if (substr($uri,-1) == "/") $uri = substr($uri, 0, -1); //Remove trailing slash, as we have chosen that source_paths in the table shouldn't contain one
