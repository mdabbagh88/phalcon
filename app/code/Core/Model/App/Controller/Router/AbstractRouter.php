...
Abstract Class AbstractRouter extends PhalconRouter 
{
    ...
    {
        Cloud::events()->fire("router:before_prime_dispatcher", $this, array(
        	"dispatcher" => $dispatcher
        ));
        Cloud::events()->fire($this->getWebsiteEventName("router", "before_prime_dispatcher"), $this, array(
        	"dispatcher" => $dispatcher
        ));
        $this->loadRoute(); 
        ...
        Cloud::events()->fire("router:after_prime_dispatcher", $this, array(
            "dispatcher" => $dispatcher
        ));
        Cloud::events()->fire($this->getWebsiteEventName("router", "after_prime_dispatcher"), $this, array(
            "dispatcher" => $dispatcher
        ));
        return $this;
    }
    ...
    public function loadRoute()
    {
        ...
        $namespace        = \Cloud::app()->getCache()->load($this->_getCacheKey("namespace-for-".$module_frontname), function() use($modules, $module_frontname) {
